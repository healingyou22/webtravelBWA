                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:160px;"><img alt="" height="auto"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    kamu sudah
                                                                    berhasil dicetak.<br><br>Booking ID
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="width: 50px;"><img
                                                                src="{{ url('frontend/images/ic_mail@2x.png') }}"
                                                                width="50px"></td>
                                                        <td
                                                            style="font-size: 10px; padding-left: 10px; color: #071c4d; font-family: Assistant, Helvetica, Arial, sans-serif;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Assitant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888b93;">
